            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <span>required，The name of the goods.</span>
                    </dd>
                    <dt>Goods description：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDbody" />
                        <span>A detailed description of the goods.</span>
                    </dd>
                    <dt>Outside trade ID：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDout_trade_no" />
                        <span>required，A numbered transaction ID （Unique inside the partner system）</span>
                    </dd>
                    <dt>Currency：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDcurrency" />
                        <span>required，The settlement currency merchant named in contract.</span>
                    </dd>
                    <dt>Payment sum：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDtotal_fee" />
                        <span>required，A floating number ranging 0.01～1000000.00</span>
                    </dd>
					<dt></dt>
                    <dd>
