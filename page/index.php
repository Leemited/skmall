...
<section class="section01">
	<header class="section01_header">
		<h1>GUIDE</h1>
		<p><a href="<?php echo G5_URL; ?>">HOME</a> &gt; <a href="<?php echo G5_URL."/page/guide"; ?>">GUIDE</a> &gt; <a href="<?php echo G5_URL."/page/guide"; ?>">이용약관</a></p>
	</header>
	<nav class="section01_nav">
		<ul>
			<li class="active"><a href="<?php echo G5_URL."/page/guide"; ?>">이용약관</a></li>
			<li><a href="<?php echo G5_URL."/page/company/privacy.php"; ?>">개인정보취급방침</a></li>
		</ul>
	</nav>
	<article class="section01_con" id="guide">
		<div class="wrap">
				<div>
					<h3>제1조(목적)</h3>
					<p>
						이 약관은 GORLLA SMARTWAY가 운영하는 GSW MALL(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다. <br />
				...
				<div>
					<h3>제2조(정의)</h3>
					<ol>
						<li>“몰”이란 GORLLA SMARTWAY가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.</li>
				...
				<div>
					...
					<ol>
						<li>“몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 GSW MALL의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</li>
				...
				<div>
					<h3>제15조(청약철회 등)</h3>
					<ol>
						<li>“몰”과 재화등의 구매에 관한 계약을 체결한 이용자는 「전자상거래 등에서의 소비자보호에 관한 법률」 제13조 제2항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은 때보다 재화 등의 공급이 늦게 이루어진 경우에는 재화 등을 공급받거나 재화 등의 공급이 시작된 날을 말합니다)부터 24시간 이내에는 청약의 철회를 할 수 있습니다. 다만, 청약철회에 관하여 「전자상거래 등에서의 소비자보호에 관한 법률」에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다. </li>
						<li>
