            ...
            <div class="adm-table02">
                <form action="<?php echo G5_URL."/admin/member_update.php"; ?>" method="post" id="fregisterform" name="fregisterform" enctype="multipart/form-data" onsubmit="return fregisterform_submit(this);">
                    ...
                    <table>
                        <tr>
                            <th>메인이미지</th>
                            <td><input type="file" name="banner" id="banner" <?php echo $id?"":"required"; ?> class="adm-input01 grid_100" value="<?php echo $write['name']; ?>" /></td>
                        </tr>
                        <tr>
                            <th>아이디</th>
                    ...
                    <div class="grid_100 mt20 text-center">
                        ...
                        <input type="submit" value="등록" id="btn_submit" class="btn adm-btn01" accesskey="s">
                    </div>
                </form>
            </div>
        </article>
